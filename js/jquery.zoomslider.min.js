!function(s) {
    function t(i, t) {
        ...
        null == this.settings.src || this.settings.src.length < 1 ? (console.log("ZoomSlider terminated - invalid input."),
        void 0) : (this.init(),
        void 0)
    }
    var e = "zoomSlider"
    ...
    s.extend(t.prototype, {
        ...
        jump: function(s) {
            if (s >= this.numSlides)
                return console.log("ZoomSlider: jump(pos) aborted. supplied index out of range."),
                void 0;
            if (this.pos != s) {
                if (this.switching)
